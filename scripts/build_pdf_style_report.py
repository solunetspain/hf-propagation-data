...
NOTES = {
    ...
    "9. NVIS EA para 160, 80, 40 y 20 m": "La columna «Estimación alcance NVIS» utiliza las capturas regionales de PSKReporter disponibles en una ventana móvil de 30 minutos; no depende únicamente del instante de generación. Es una estimación operativa y prudente de la distancia predominante observada en ese momento; no es un axioma, una ley fija de la propagación ni una probabilidad de contacto. «Probablemente corta» indica una distancia mediana inferior a 500 km. «Mixta» indica entre 500 y 1.500 km cuando no hay una separación geográfica clara. Si aparecen simultáneamente zonas locales y externas, se utiliza «Selectiva por zonas» y se muestran solo las zonas externas identificadas. «Probablemente larga» indica 2.500 km o más. Para la Península se consideran locales EA1, EA2, EA3, EA4, EA5 y EA7; EA6 y EA8 son externas. EA6 es local para Baleares y EA8 es local para Canarias. Los distritos entre paréntesis proceden de los indicativos observados por PSKReporter: no son provincias, no describen toda la cobertura y dependen de que haya estaciones activas. Con menos de tres reportes o sin distancia mediana se muestra «Sin evidencia suficiente». NVIS favorece trayectos cortos y de incidencia casi vertical; no debe confundirse con propagación regional garantizada. 80 m suele ofrecer cobertura cercana pero sufre más absorción diurna; 40 m puede ser una transición útil entre proximidad y trayectos medios; 20 m favorece saltos más amplios y Europa/DX, pero normalmente no es la primera opción NVIS. La acción práctica combina foF2, absorción, tendencia y observaciones PSKReporter. «Usar en trayectos oblicuos» significa utilizar esa banda para comunicaciones cuyo recorrido no sea casi vertical ni estrictamente local, sino con un ángulo de llegada intermedio.",
